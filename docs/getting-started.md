...
```
bunx degit epicweb-dev/epicflare my-macro-tracker-app
cd my-macro-tracker-app
```
...
- You can write to files in the repository (the script updates config files and
  replaces template `macro-tracker` tokens across text files).
