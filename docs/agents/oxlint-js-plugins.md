...
- Plugin name: `macro-tracker-custom`
- Rule id: `no-example-identifier`
- Config key: `macro-tracker-custom/no-example-identifier`
...
You should see a lint error from `macro-tracker-custom/no-example-identifier`.
